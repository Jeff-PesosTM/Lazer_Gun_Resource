...
//LCD brightness potentiometer (VO pin) = 4k7 ohm resistor (@ 5V power)
//https://www.thingiverse.com/thing:4207521
//https://www.thingiverse.com/thing:3146046
//https://www.thingiverse.com/thing:3658610 (To Do After Maybe)
//https://hackaday.io/project/160804-lzrtag-flexible-diy-lasertag

//IRremote library is reverted to v2.5
...
IRrecv irrecv(RECV_PIN);  //passive?
...
void setup() {
  ...
  pinMode(amoresetpin, INPUT);  //resets amo, what is the coast?
...
void shoot() {
  if ((triggbuttonState == HIGH) && (amolevel > 0) && (damagelevel > 0) && (reloading > reload_time)) {
    ...
    for (int i = 500; i < 600; i++) {  //make some noise
